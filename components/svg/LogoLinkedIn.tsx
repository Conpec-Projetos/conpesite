/* Via Simple Icons (CC0) */

import type { SVGProps } from 'react'

export default function LogoLinkedIn(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      <path d="m116 3h-104a8.91 8.91 0 0 0 -9 8.8v104.42a8.91 8.91 0 0 0 9 8.78h104a8.93 8.93 0 0 0 9-8.81v-104.42a8.93 8.93 0 0 0 -9-8.77z" fill="currentColor" />
      <g fill="var(--laranja-conpec)">
